...
import (
  ...
  agentModules "github.com/threatcode/threatcode-soc/agent/modules"
  ...
  serverModules "github.com/threatcode/threatcode-soc/server/modules"
  "os"
  "os/signal"
  "syscall"
  "time"
...
func main() {
  configFilename := flag.String("c", "threatsensor.json", "Configuration file, in JSON format")
  flag.Parse()
